...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HintsEngineConfig) DeepCopyInto(out *HintsEngineConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HintsEngineConfig.
func (in *HintsEngineConfig) DeepCopy() *HintsEngineConfig {
	if in == nil {
		return nil
	}
	out := new(HintsEngineConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedDatabaseSpec) DeepCopyInto(out *ManagedDatabaseSpec) {
	*out = *in
	...
	if in.HintsEngine != nil {
		in, out := &in.HintsEngine, &out.HintsEngine
		*out = new(HintsEngineConfig)
		**out = **in
	}
}
